...
def get_data(batch_size=32, image_shape=(48, 48), train_data_dir="./PKLotSegmented/PUC/Cloudy/train", validation_data_dir="./PKLotSegmented/PUC/Cloudy/test"):
    files_train = 99584
    files_validation = 33196
