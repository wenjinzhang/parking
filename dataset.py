...
def get_data(batch_size=32, image_shape=(48, 48), train_data_dir="./PKLotSegmented/UFPR04/Rainy/train", validation_data_dir="./PKLotSegmented/UFPR04/Rainy/test"):
    files_train = 5229
    files_validation = 2729
